...
five = Comment.create(reply: "Hello there to you Jimmy!", user: jane, blog: post_one)
six = Comment.create(reply: "How is your day?", user: jimmy, blog: post_one)
seven = Comment.create(reply: "It's going pretty well. Been coding all day and I am pooped!", user: jane, blog: post_one)